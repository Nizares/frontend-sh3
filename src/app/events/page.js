...
export default function Events() {
  ...
  if (loading)
    return (
      <div className="flex justify-center p-16 text-2xl h-screen mt-24">
        Loading...
      </div>
    );
  return (
    <Container className="flex flex-col relative bg-linear-to-b from-primary-light to-primary-light-hover">
      <BatikOverlay />
      <div className="flex flex-col flex-1 mx-auto mb-8 p-8">
        <div className="flex flex-col flex-1 items-center justify-center mt-16">
          <h1 className="text-text-colors text-5xl font-bold font-young text-primary-dark-active ">
            Events
          </h1>
        </div>
