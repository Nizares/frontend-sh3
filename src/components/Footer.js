...
export default function Footer() {
    return (
        <div className="flex flex-col items-center w-full bg-primary-dark h-auto ">
            <div className="flex flex-col md:flex-row justify-between w-full px-4 md:px-0">
                <svg width="250" height="inherit" viewBox="0 0 71 39" fill="none" xmlns="http://www.w3.org/2000/svg">
